...
func (o *Options) FillConfig() {
	...
	o.SlackAPITokenPath = viper.GetString("slack_api_token_path")
	o.SlackChannelIDs = viper.GetStringSlice("slack_channel_ids")
	o.SlackSigningSecretPath = viper.GetString("slack_signing_secret_path")
